...
export default function BookInfo({ bookImage, title, author, publisher, pubdate }: BookInfoProps) {
  return (
    <div className="border-dark-gray flex gap-x-2 border-b py-4">
      <Image width={94} height={140} alt={'book'} src={bookImage} className="mx-2" />
